...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 max-w-full  mx-auto text-center dark:bg-gray-900">
      <h3 className="text-3xl font-semibold mb-10 text-indigo-600 dark:text-indigo-400">Projects</h3>
      <div className="grid md:grid-cols-2 gap-8 mx-40">
        {projects.map((p, i) => (
          <motion.div
            key={i}
            className="bg-white dark:bg-gray-500 rounded-2xl shadow-md p-6"
